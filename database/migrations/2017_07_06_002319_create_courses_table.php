...
class CreateCoursesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('courses', function (Blueprint $table) {
            ...
            $table->string('holes');
            $table->string('tournament_tee_length',255);
            $table->string('back_tee_length',255);
            $table->string('middle_tee_length',255);
            $table->string('front_tee_length',255);
            $table->string('tournament_tee_slope_rating',255)->nullable();
